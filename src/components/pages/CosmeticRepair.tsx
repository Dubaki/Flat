  ...
  return (
    <div className="pt-24 min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-8">
          <a href="/" className="text-accent hover:underline text-sm font-medium flex items-center gap-2">
            ← На главную
          </a>
        </div>
        ...
        <h2 className="text-3xl font-bold mb-8 text-center font-serif text-slate-900">Что входит в косметический ремонт?</h2>
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {[
            { title: 'Демонтаж', desc: 'Снятие старых обоев, линолеума, плинтусов и розеток.' },
            { title: 'Подготовка стен', desc: 'Частичная Шпатлёвка, грунтовка стен перед поклейкой.' },
